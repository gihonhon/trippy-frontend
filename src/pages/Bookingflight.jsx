          ...
          <div className="col-span-2 bg-[#f1f5f5]  px-8 pb-8  rounded-md">
            ...
            <div className="flex flex-col gap-y-10">
                <div className='my-4 mx-2'>
                    <div>
                        <h1 className='text-xl font-medium'>Title<span className='text-red-400'>*</span></h1>
                        <Controller
                        name='title'
                        control={control}
                        defaultValue=''
                    ...
                    <div className='my-4 mx-2'>
                        <div>
                            <h1 className='text-xl font-medium'>Fullname<span className='text-red-400'>*</span></h1>
                            <Controller
                            name='fullName'
                            control={control}
                            defaultValue=''
                    ...
                    <div className='my-4 mx-2'>
                        <div>
                            <h1 className='text-xl font-medium'>Email<span className='text-red-400'>*</span></h1>
                            <Controller
                            name='email'
                            control={control}
                            defaultValue=''
                    ...
                    <div className='my-4 mx-2'>
                        <div>
                            <h1 className='text-xl font-medium'>Phone<span className='text-red-400'>*</span></h1>
                            <Controller
                            name='phone'
                            control={control}
                            defaultValue=''
                    ...
                    <div className='my-4 mx-2'>
                        <div>
                            <h1 className='text-xl font-medium'>Citizen<span className='text-red-400'>*</span></h1>
                            <Controller
                            name='citizen'
                            control={control}
                            defaultValue=''
